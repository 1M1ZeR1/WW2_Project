...
public class BuildMenuUpgradeScript : MonoBehaviour
{
    ...
    private Dictionary<BuildsEnum, (GameObject, GameObject)> buttonsByType = new();
    ...
    {
        foreach(Transform panel in listPanelTaker) 
        {
    ...
    private void EnableInteractionAllButtons()
    {
        ...
        {
           var buttons = buttonsByType[ServiceRegistry.WorkWithController<BuilderController>().cellsToBuildingObjects[_currentCell].Item1.Type];
