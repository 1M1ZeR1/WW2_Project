...
public class CellUIScript : MonoBehaviour
{
    ...
    protected InteractableScript _interactableScript;
    ...
    void Start()
    {
        ...
        _interactableScript = GetComponent<InteractableScript>();
        _interactableScript.playerIsInteract += ShowInformation;
